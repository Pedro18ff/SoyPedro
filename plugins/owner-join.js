...
let handler = async (m, { conn, text, isOwner }) => {
    if (!text) return m.reply('> *‼️Debes enviar una invitacion para que *D E Y* se una al grupo.*');
    ...
    if (isOwner) {
        ...
        await conn.sendMessage('51994884471' + '@s.whatsapp.net', { text: message, mentions: [m.sender] }, { quoted: m });
